...
varA = randomString(chars, 10)

WebUI.callTestCase(findTestCase('Common Test Cases/login from embed'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Common Test Cases/login from VSTS'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Common Test Cases/Login from standalone'), [('pass2') : 'inte3GREAT', ('user2') : 'shehzad.ali'
        , ('service2') : 'http://shehzad:8028', ('server') : 'http://arsalanmushtaq:8080/tfs'], FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('New Folder/Page_Modern Requirements4TFS 2018/a_FAQ'))
